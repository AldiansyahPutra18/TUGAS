    ...
    <div class="col-md-5 col-md-offset-3">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                ?>
                <form method="post" action="penyewaan_update.php">
                    <div class="form-group">
                        <label>Nama</label>
                        <!-- Form id pelanggan yang diedit, untuk dikirim ke file aksi -->
                        <input type="hidden" name="id" value="<?php echo $d['id_peminjaman']; ?>">
                    ...
                    <div class="form-group">
                        <label>Harga</label>
                        <input type="varchar" class="form-control" name="harga" placeholder="Masukkan harga .." value="<?php echo $d['harga']; ?>">
                    </div>
                    <div class="form-group">
                        <label>Jaminan</label>
